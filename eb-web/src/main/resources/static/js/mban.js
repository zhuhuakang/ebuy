...
jQuery(document).ready(function () {
    ...
    var speed = 500;
    var w = 211;
    var n = jq('#actor3 li').length;
    var numWidth = n * 18;
    var _left = (w - (numWidth + 26)) / 2;
    var c = 0;
    jq('#actor3').width(w * n);
    jq('#actor3 li').each(function (i) {
        str += '<span></span>'
    });
    jq('#numInner').width(numWidth).html(str);
    jq('#imgPlay3 .mc').width(numWidth);
    jq('#imgPlay3 .num').css('left', _left);
    ...
    function slide(j) {
        if (jq('#actor3').is(':animated') == false) {
            c += j;
            if (c != -1 && c != n) {
                jq('#actor3').animate({
                        'marginLeft': -c * w + 'px'
    ...
    function fade(i) {
        if (jq('#actor3').css('marginLeft') != -i * w + 'px') {
            jq('#actor3').css('marginLeft', -i * w + 'px');
            jq('#actor3').fadeOut(0,
                function () {
                    jq('#actor3').fadeIn(500)
                })
        }
    }
