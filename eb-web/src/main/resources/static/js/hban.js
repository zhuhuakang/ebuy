...
jQuery(document).ready(function () {
    ...
    var speed = 500;
    var w = 211;
    var n = jq('#actor5 li').length;
    var numWidth = n * 18;
    var _left = (w - (numWidth + 26)) / 2;
    var c = 0;
    jq('#actor5').width(w * n);
    jq('#actor5 li').each(function (i) {
        str += '<span></span>'
    });
    jq('#numInner').width(numWidth).html(str);
    jq('#imgPlay5 .mc').width(numWidth);
    jq('#imgPlay5 .num').css('left', _left);
    ...
    jq('.home_ban #imgPlay5 .next_h').click(function () {
        slide(1)
    });
    jq('.home_ban #imgPlay5 .prev_h').click(function () {
        slide(-1)
    });

    function slide(j) {
        if (jq('#actor5').is(':animated') == false) {
            c += j;
            if (c != -1 && c != n) {
                jq('#actor5').animate({
                        'marginLeft': -c * w + 'px'
    ...
    function fade(i) {
        if (jq('#actor5').css('marginLeft') != -i * w + 'px') {
            jq('#actor5').css('marginLeft', -i * w + 'px');
            jq('#actor5').fadeOut(0,
                function () {
                    jq('#actor5').fadeIn(500)
                })
        }
    }
