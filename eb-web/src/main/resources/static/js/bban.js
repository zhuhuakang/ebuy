...
jQuery(document).ready(function () {
    ...
    var speed = 500;
    var w = 211;
    var n = jq('#actor4 li').length;
    var numWidth = n * 18;
    var _left = (w - (numWidth + 26)) / 2;
    var c = 0;
    jq('#actor4').width(w * n);
    jq('#actor4 li').each(function (i) {
        str += '<span></span>'
    });
    jq('#numInner').width(numWidth).html(str);
    jq('#imgPlay4 .mc').width(numWidth);
    jq('#imgPlay4 .num').css('left', _left);
    ...
    jq('.baby_ban #imgPlay4 .next_b').click(function () {
        slide(1)
    });
    jq('.baby_ban #imgPlay4 .prev_b').click(function () {
        slide(-1)
    });

    function slide(j) {
        if (jq('#actor4').is(':animated') == false) {
            c += j;
            if (c != -1 && c != n) {
                jq('#actor4').animate({
                        'marginLeft': -c * w + 'px'
    ...
    function fade(i) {
        if (jq('#actor4').css('marginLeft') != -i * w + 'px') {
            jq('#actor4').css('marginLeft', -i * w + 'px');
            jq('#actor4').fadeOut(0,
                function () {
                    jq('#actor4').fadeIn(500)
                })
        }
    }
