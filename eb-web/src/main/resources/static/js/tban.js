...
jQuery(document).ready(function () {
    ...
    var speed = 500;
    var w = 211;
    var n = jq('#actor6 li').length;
    var numWidth = n * 18;
    var _left = (w - (numWidth + 26)) / 2;
    var c = 0;
    jq('#actor6').width(w * n);
    jq('#actor6 li').each(function (i) {
        str += '<span></span>'
    });
    jq('#numInner').width(numWidth).html(str);
    jq('#imgPlay6 .mc').width(numWidth);
    jq('#imgPlay6 .num').css('left', _left);
    ...
    jq('.tel_ban #imgPlay6 .next_t').click(function () {
        slide(1)
    });
    jq('.tel_ban #imgPlay6 .prev_t').click(function () {
        slide(-1)
    });

    function slide(j) {
        if (jq('#actor6').is(':animated') == false) {
            c += j;
            if (c != -1 && c != n) {
                jq('#actor6').animate({
                        'marginLeft': -c * w + 'px'
    ...
    function fade(i) {
        if (jq('#actor6').css('marginLeft') != -i * w + 'px') {
            jq('#actor6').css('marginLeft', -i * w + 'px');
            jq('#actor6').fadeOut(0,
                function () {
                    jq('#actor6').fadeIn(500)
                })
        }
    }
