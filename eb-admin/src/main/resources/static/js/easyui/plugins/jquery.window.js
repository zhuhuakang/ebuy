...
(function ($) {
    ...
    function _17(_18) {
        ...
        if (_19.options.modal == true) {
            ...
            _19.mask.css({
                width: (_19.options.inline ? _19.mask.parent().width() : _1e().width),
                height: (_19.options.inline ? _19.mask.parent().height() : _1e().height),
                display: "none"
            });
        }
        if (_19.shadow) {
    ...
    function _1f(_20) {
        ...
        _21.window.draggable({
            handle: ">div.panel-header>div.panel-title",
            disabled: _21.options.draggable == false,
        ...
        _21.window.resizable({
            disabled: _21.options.resizable == false, onStartResize: function (e) {
                _21.pmask = $("<div class=\"window-proxy-mask\"></div>").insertAfter(_21.window);
                _21.pmask.css({
                    zIndex: $.fn.window.defaults.zIndex++,
                    left: e.data.left,
                    top: e.data.top,
                    width: _21.window._outerWidth(),
                    height: _21.window._outerHeight()
                });
                if (!_21.proxy) {
                    _21.proxy = $("<div class=\"window-proxy\"></div>").insertAfter(_21.window);
                }
    ...
    $.fn.window.methods = {
        options: function (jq) {
            ...
            return $.extend(_27, {
                closed: _26.closed,
                collapsed: _26.collapsed,
                minimized: _26.minimized,
                maximized: _26.maximized
            });
        }, window: function (jq) {
    ...
    $.fn.window.parseOptions = function (_2a) {
        return $.extend({}, $.fn.panel.parseOptions(_2a), $.parser.parseOptions(_2a, [{
            draggable: "boolean",
            resizable: "boolean",
            shadow: "boolean",
            modal: "boolean",
