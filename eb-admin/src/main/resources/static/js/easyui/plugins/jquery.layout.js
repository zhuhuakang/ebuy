    ...
    function _2f(_30, _31, _32) {
        ...
        function _38() {
            ...
            if (_31 == "east") {
                ...
                return {
                    resizeC: {width: ww},
                    expand: {left: cc.width() - _34.width},
                    expandP: {top: _3b.top, left: cc.width() - _3c, width: _3c, height: _3b.height},
                    collapse: {left: cc.width(), top: _3b.top, height: _3b.height}
                };
            } else {
                if (_31 == "west") {
                    var ww = _3b.width + _34.width - _3c;
                    ...
                    return {
                        resizeC: {width: ww, left: _3c - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _3b.top, width: _3c, height: _3b.height},
                        collapse: {left: -_34.width, top: _3b.top, height: _3b.height}
                    };
                } else {
                    if (_31 == "north") {
                        var hh = _3b.height;
                        ...
                        return {
                            resizeC: {top: _3c - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: _3c},
                            collapse: {top: -_34.height, width: cc.width()}
                        };
                    } else {
                        if (_31 == "south") {
                            var hh = _3b.height;
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _34.height},
                                expandP: {top: cc.height() - _3c, left: 0, width: cc.width(), height: _3c},
    ...
    function _3d(_3e, _3f) {
        ...
        function _43() {
            ...
            if (_3f == "east" && _40.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _45.top, height: _45.height},
                    expand: {left: cc.width() - _40["east"].panel("options").width}
                };
            } else {
                if (_3f == "west" && _40.expandWest) {
                    return {
                        collapse: {left: -_40["west"].panel("options").width, top: _45.top, height: _45.height},
                        expand: {left: 0}
                    };
                } else {
                    if (_3f == "north" && _40.expandNorth) {
                        return {
                            collapse: {top: -_40["north"].panel("options").height, width: cc.width()},
                            expand: {top: 0}
                        };
                    } else {
                        if (_3f == "south" && _40.expandSouth) {
                            return {
                                collapse: {top: cc.height(), width: cc.width()},
                                expand: {top: cc.height() - _40["south"].panel("options").height}
                            };
                        }
                    }
                }
